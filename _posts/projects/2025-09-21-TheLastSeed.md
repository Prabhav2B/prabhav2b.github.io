...
<img style="text-align: left ; width: calc(100% - 20px) ; height:auto; box-shadow: -5px 5px 15px #888888;;" src="/assets/gifs/tls/cave.gif">
...
<figure>
    <img style="text-align: left ; width: calc(100% - 20px) ; height:auto; box-shadow: -5px 5px 15px #888888;;" src="/assets/media/tls/resting_on_water.gif">
    <figcaption>Fig.1 - The player movement was designed to feel soft and gentle. Also, the reflective water shader helped build the aestheic of the game.</figcaption>
</figure>
...
<figure>
    <img style="text-align: left ; width: calc(100% - 20px) ; height:auto; box-shadow: -5px 5px 15px #888888;;" src="/assets/media/tls/camera_transitions.gif">
    <figcaption>Fig.2 - Camera transition design to build a sense of tightness and claustrophobia.</figcaption>
</figure>
...
<figure>
    <img style="text-align: left ; width: calc(100% - 20px) ; height:auto; box-shadow: -5px 5px 15px #888888;;" src="/assets/media/tls/ending.gif">
    <figcaption>Fig.3 - A pleaseantly subversive ending. Moving slowly, but freely in open air, towards the rest of the dandelions built a resonant moment with the players.
